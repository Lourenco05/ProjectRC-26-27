...
/* Envia msg ao DS através de sockfd e aguarda a resposta, guardando-a
 * em response (terminada em '\0', até resp_len - 1 bytes de dados).
 *
 * Devolve 0 em caso de sucesso, -1 em caso de erro de comunicação
 * (timeout no recvfrom, ou falha de sendto/recvfrom).
 */
 ...
 * imprimindo o resultado para o utilizador. */
